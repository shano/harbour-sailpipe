    ...
    MouseArea {
        ...
        Column {
            ...
            Row {
                ...
                StatItem {
                    source: "image://sailpipe/icon-s-media-count?" + Theme.highlightColor
                    //% "%n items"
                    text: qsTrId("sailpipe_playlist_detail-item-count", playlistModel.streamCount)
                }
            ...
            KeyValue {
                //% "Uploader"
                key: qsTrId("sailpipe_playlist_details-detail_uploader")
                value: playlistModel.uploaderName
            }

            KeyValue {
                //% "Description"
                key: qsTrId("sailpipe_playlist_details-detail_description")
