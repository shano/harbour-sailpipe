...
#ifndef DECLARATIVEVIDEOOUTPUT_P_H
#define DECLARATIVEVIDEOOUTPUT_P_H
...
class DeclarativeVideoOutput : public QQuickItem
{
    Q_OBJECT
    Q_DISABLE_COPY(DeclarativeVideoOutput)
...
public:
    ...
    DeclarativeVideoOutput(QQuickItem *parent = 0);
    ~DeclarativeVideoOutput();
...
Q_SIGNALS:
    void sourceChanged();
    void fillModeChanged(DeclarativeVideoOutput::FillMode);
...
#endif // DECLARATIVEVIDEOOUTPUT_H
